    ...
    return (
        <section id="about" className="py-24 px-6 max-w-3xl mx-auto">
            ...
            <div className="space-y-4 text-zinc-400 text-lg leading-relaxed">
                <p>
                    Ich bin ein leidenschaftlicher Web-Entwickler mit Fokus auf moderne, performante
                    und wartbare Web-Applikationen. Mit mehreren Jahren Erfahrung in der
                    Softwareentwicklung bringe ich Ideen zum Leben — von der Konzeption bis zum
                    Deployment.
                </p>
                <p>
                    Wenn ich nicht code, beschäftige ich mich mit Open-Source-Projekten oder lerne
                    neue Technologien kennen.
                </p>
            </div>
